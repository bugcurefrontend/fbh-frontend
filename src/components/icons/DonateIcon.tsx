...
interface DonateIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0)">
        ...
        <path
          d="M9.06844 11.25C8.15625 10.0988 7.5 8.86501 7.5 7.50001C7.5 5.46657 9.15656 3.75001 11.1994 3.75001C11.9295 3.74144 12.6455 3.951 13.2558 4.35184C13.8661 4.75269 14.3428 5.32657 14.625 6.00001C14.9072 5.32657 15.3839 4.75269 15.9942 4.35184C16.6045 3.951 17.3205 3.74144 18.0506 3.75001C20.0934 3.75001 21.75 5.46657 21.75 7.50001C21.75 10.2403 19.1081 12.6628 17.0419 14.1863"
          stroke="currentColor"
          strokeWidth={strokeWidth}
          strokeLinecap="round"
          strokeLinejoin="round"
