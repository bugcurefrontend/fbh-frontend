const UsersIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_6196_32541)">
        <path
        ...
        />
        <path
          d="M0.959106 18.75C1.70825 17.5982 2.73323 16.6517 3.94098 15.9965C5.14873 15.3412 6.50101 14.998 7.87504 14.998C9.24908 14.998 10.6014 15.3412 11.8091 15.9965C13.0169 16.6517 14.0418 17.5982 14.791 18.75"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
