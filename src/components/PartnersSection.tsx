...
const PartnersSection: React.FC = () => {
  ...
  return (
    <section className="bg-white md:mx-8 rounded-xl border border-gray-200  max-sm:py-6 max-sm:pb-10 sm:py-4 text-center space-y-10 sm:space-y-14 sm:h-[232px] mt-16">
