...
import { Box, Typography, Button, Stack, Card, CardContent, CardMedia, IconButton, Chip } from '@mui/material';
  ...
  const activities = [
    {
      ...
      description: 'Kanha Gym is equipped with world-class fitness facilities. Gym offers the options to workout pla…',
      image: '/images/gym-facilities.png'
    },
    {
      date: '15 JAN',
      title: 'Kanha Sports Centre inaugurated',
      description: 'An Kanha Sports Centre at Kanha Shanti Vanam, established by the Ministry of Sports, Khelo India, …',
      image: '/images/sports-centre.jpg'
    },
    {
      date: '15 JAN',
      title: 'Talent Identification, Physical Literacy key to',
      description: 'India\'s Chief National Badminton Coach Pullela Gopichand says…',
  ...
  return (
    <ActivitiesContainer>
      <SectionHeader direction="row">
        <SectionTitle>FBH Activities</SectionTitle>
        <ViewAllButton>View All</ViewAllButton>
      </SectionHeader>

      <ActivitiesGrid direction="row">
