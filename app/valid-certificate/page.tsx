...
const page = () => {
  ...
  return (
    <main className="max-w-7xl mx-auto md:px-8 px-4 flex flex-col items-center justify-center mt-8">
      ...
      <p className="leading-6 text-[#090C0F] mt-4 max-md:hidden">
        Few trees are in the planting queue and will be planted shortly. Their
        locations will appear here once planting is complete. Thank you for your
        patience.
      </p>
    </main>
  );
